...
var $author$project$Models$Article = F4(
	function (title, tags, articleText, updatedTime) {
		return {articleText: articleText, tags: tags, title: title, updatedTime: updatedTime};
	});
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$Main$articlesView, $author$project$Main$jst, model.articles)
							]))
					]))
			]),
		title: 'ブログ予定地'
