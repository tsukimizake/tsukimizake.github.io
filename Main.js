...
{
	if (region.aN.ai === region.a_.ai)
	{
		return 'on line ' + region.aN.ai;
	}
	return 'on lines ' + region.aN.ai + ' through ' + region.a_.ai;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cg, request.cP, true);
		} catch (e) {
...
function _Markdown_formatOptions(options)
{
	...
	{
		if (!lang && $elm$core$Maybe$isJust(options.aY))
		{
			lang = options.aY.a;
		}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a2: fragment, a6: host, bj: path, bl: port_, bp: protocol, bq: query};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bQ: false, bT: r.bT, b2: r.b2, b9: r.b9, cg: r.cg, cM: r.cM, bH: r.bH, cP: r.cP}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{bT: $elm$http$Http$emptyBody, b2: r.b2, b9: _List_Nil, cg: 'GET', cM: $elm$core$Maybe$Nothing, bH: $elm$core$Maybe$Nothing, cP: r.cP});
};
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									'投稿日:' + A2($author$project$Main$showTime, zone, post.cO))
								])),
							A2(
							$elm$html$Html$ul,
							_List_Nil,
